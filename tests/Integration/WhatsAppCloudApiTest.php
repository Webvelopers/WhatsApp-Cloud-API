...
use Webvelopers\WhatsAppCloudApi\Message\Contact\PhoneType;
use Webvelopers\WhatsAppCloudApi\Message\Media\LinkID;
use Webvelopers\WhatsAppCloudApi\Message\Media\MediaObjectID;
use Webvelopers\WhatsAppCloudApi\Message\OptionsList\Action;
use Webvelopers\WhatsAppCloudApi\Message\OptionsList\Row;
use Webvelopers\WhatsAppCloudApi\Message\OptionsList\Section;
...
final class WhatsAppCloudApiTest extends TestCase
{
    ...
    {
        $link_id = new LinkID('https://Webvelopers.es/wp-content/uploads/2022/05/image.png');
        $response = $this->whatsapp_app_cloud_api->sendDocument(
            WhatsAppCloudApiTestConfiguration::$to_phone_number_id,
            $link_id,
    ...
    {
        $link_id = new LinkID('https://Webvelopers.es/wp-content/uploads/2022/05/sample3.aac');
    ...
    {
        $link_id = new LinkID('https://Webvelopers.es/wp-content/uploads/2022/05/whatsapp_cloud_api_banner-1.png');
    ...
    {
        $response = $this->whatsapp_app_cloud_api->uploadMedia('tests/Support/Webvelopers.png');
